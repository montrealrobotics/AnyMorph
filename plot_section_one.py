...
if __name__ == "__main__":
    ...
    for exp_i, exp_name in enumerate([
        ...
        for method_name, exp_path in zip([
            "Ours", "Amorpheus", "SMP"], [exp_name + "-universal-2-?/*/metrics.json", 
            "brandont-" + exp_name + "-amorpheus-?/*/metrics.json",
            "brandont-" + exp_name + "-smp-?/*/metrics.json"]):
        ...
        g = sns.lineplot(data=data, 
                         ...
                         linewidth=4, ax=axs[exp_i // 4, exp_i % 4])
    ...
    plt.savefig(os.path.join(parent_dir, "section_one-2.pdf"))
    plt.savefig(os.path.join(parent_dir, "section_one-2.png"))
